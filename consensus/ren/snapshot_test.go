...
func TestClique(t *testing.T) {
	...
	for i, tt := range tests {
		...
		config.Ren = &params.RenConfig{
			DNR: common.HexToAddress("0x0000000000000000000000000000000000000001"),
			API: "0x0000000000000000000000000000000000000001",

			Period: 1,
			Epoch:  tt.epoch,
		}
		engine := New(config.Ren, db)
